@extend('layouts/admin', ['title' => 'CCE Guidelines'])
...
{if empty(PDS::where('user_id',$client->id)->first())}
    <h4><i class="fa fa-frown-o"></i> There's no information from this member yet. <br>
        <small>Either it was just created or the member hasn't yet filled out the Personal Data Sheet.</small>
    </h4>
    <a href="/admin/pds" class="btn btn-primary">Take me back.</a>
{else}

    {if $client != null}
    <h4 class="pull-left">Basic Information</h4>
    <div class="pull-right">
        <a href="/admin/pds/evaluate/{{$client->id}}" class="btn btn-success"><i class="fa fa-database"></i> Evaluate Points</a>
        <a class="btn btn-primary" target="_blank" href="/admin/pds/print/{{$client->id}}"><i class="fa fa-print"></i> Print this page</a>
    </div>
    ...
    <div id="ctr" data-url="/admin/docs/fetchID/{{$client->id}}" class="well nsh" style="border: 1px solid #efefef"></div>
    <hr>
    ...
    <div class="well nsh" style="border: 1px solid #efefef">
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>{if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/EducationalAttainment/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                    {else}
                       Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                    {endif}
            </tr>
            {endforeach}
        </table>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/AdditionalCredits/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
    ...
    <div class="well nsh" style="border: 1px solid #efefef">
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ServiceRecord/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
    ...
    <div class="well nsh" style="border: 1px solid #efefef">
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/DevelopedPatents/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/PublishedLiteratures/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/TrainingCourses/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ConferencesSeminars/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/Consultancy/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/TrainingsWorkshops/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ExpertServices/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/Accreditations/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ProfessionalMemberships/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/AcademicHonors/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/Scholarships/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/Achievements/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/CommunityOutreach/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ProfessionalExaminations/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
    ...
    <div class="well nsh" style="border: 1px solid #efefef">
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ResearchContributions/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/ProfessionalTutoring/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
        ...
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                {if $data->approval_status == 'review'}
                    <a href="/admin/pds/toggle/IndustrialResearches/{{$data->id}}/{{$client->id}}">[Click to approve]</b></a></td>
                {else}
                    Approved on <b>{{date('F j, Y',$data->updated)}}</b>
                {endif}
            </tr>
    ...
    <div class="alert alert-warning">
        <h4>Sorry, I couldnt find the data. </h4>
        <span>Please use either an <b>Email/ID/Username</b></span>
    </div>

    <div class="well">
        <div class="form-group">
            <input type="text" class="form-control input-lg" id="pds-search-2" placeholder="Search for PDS record:">
        </div>
        <center>
            <button type="submit" class="btn btn-primary btn-lg"
                    onclick="if(document.querySelector('#pds-search-2').value == '')return false;location.href = '/admin/pds/search/' + document.querySelector('#pds-search-2').value"><i class="fa fa-search"></i> Search
            </button>
        </center>
    </div>
    {endif} <!--if wrapper-->
