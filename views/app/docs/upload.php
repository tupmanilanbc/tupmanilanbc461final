@extend('layouts/frontend', ['title' => 'Upload a file'])

<a href="/app/docs" class="btn btn-sm btn-primary">back to <b>Documents</b></a>
<hr>
<p class="help-block">
...
<div class="row">
    <div class="col-md-4">
        ...
        <select id="category" class="form-control">
            ...
            <option value="experience">Experience and Length of Service</option>
            <option value="professional">Professional Development,Achievements,Honors</option>
...
<script>
    ...
    uploader.onchange = function () {
        if (uploader.files[0] != undefined) {
            ...
            request.open('POST', '/app/docs/store', true);
            request.send(data);
