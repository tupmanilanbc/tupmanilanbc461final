...
<h3><i class="fa fa-newspaper-o"></i> Personal Data Sheet <br>
    <small>Information once submitted are subject for review and approval.</small>
</h3>
<hr>

<?php

function removeButton ($model, $data) {
    if ($data->approval_status == 'approved') {
        return "Approved on " . date('F j, Y', $data->updated);
    } else {
        print "<a href='javascript:;' onclick=\"cms.checkpoint('/app/pds/destroy/$model/$data->id')\">Remove</a>";
    }
}
...
<table class="table table-condensed well">
    ...
    <?php $PDS = PDS::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
    {foreach $PDS as $data}
    <tr>
...
<div class="well nsh" style="border: 1px solid #efefef">
    ...
    <table class="table table-condensed well">
        <tr>
            ...
            <th>Approval</th>
            <th>Created</th>
            <th>Approval Stamp</th>
        </tr>
        <?php $educationalAttainment = EducationalAttainment::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{removeButton('EducationalAttainment', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $additionalCredits = AdditionalCredits::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('AdditionalCredits', $data)}}</td>
        </tr>
        {endforeach}
    </table>
</div>
...
<div class="well nsh" style="border: 1px solid #efefef">
    ...
    <table class="table table-condensed well">
        ...
        <?php $ServiceRecord = ServiceRecord::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ServiceRecord', $data)}}</td>
        </tr>
        {endforeach}
    </table>
</div>
...
<div class="well nsh" style="border: 1px solid #efefef">
    ...
    <table class="table table-condensed well">
        ...
        <?php $DevelopedPatents = DevelopedPatents::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('DevelopedPatents', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $PublishedLiteratures = PublishedLiteratures::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('PublishedLiteratures', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $TrainingCourses = TrainingCourses::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('TrainingCourses', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $ConferencesSeminars = ConferencesSeminars::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ConferencesSeminars', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $Consultancy = Consultancy::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('Consultancy', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $TrainingsWorkshops = TrainingsWorkshops::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('TrainingsWorkshops', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $ExpertServices = ExpertServices::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ExpertServices', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $Accreditations = Accreditations::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('Accreditations', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $ProfessionalMemberships = ProfessionalMemberships::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ProfessionalMemberships', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $AcademicHonors = AcademicHonors::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('AcademicHonors', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $Scholarships = Scholarships::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('Scholarships', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $Achievements = Achievements::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('Achievements', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $CommunityOutreach = CommunityOutreach::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('CommunityOutreach', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $ProfessionalExaminations = ProfessionalExaminations::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ProfessionalExaminations', $data)}}</td>
        </tr>
        {endforeach}
    </table>
</div>
...
<div class="well nsh" style="border: 1px solid #efefef">
    ...
    <table class="table table-condensed well">
        ...
        <?php $ResearchContributions = ResearchContributions::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ResearchContributions', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $ProfessionalTutoring = ProfessionalTutoring::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('ProfessionalTutoring', $data)}}</td>
        </tr>
        {endforeach}
    </table>
    ...
    <table class="table table-condensed well">
        ...
        <?php $IndustrialResearches = IndustrialResearches::where('user_id', Session::get('client')->id)->order('id', 'desc')->get(); ?>
        ...
        <tr>
            ...
            <td>{{$data->approval_status}}</td>
            <td>{{date('Y-m-d',$data->created)}}</td>
            <td>{{removeButton('IndustrialResearches', $data)}}</td>
        </tr>
        {endforeach}
    </table>
</div>
