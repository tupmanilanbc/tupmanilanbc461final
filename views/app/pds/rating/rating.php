@extend('layouts/frontend', ['title' => 'Evaluations'])
...
<h4 class="pull-left"><i>Evaluated last {{$rating->date_certified}} by
        {{User::find($rating->evaluator_id)->pull('firstname').'
        '.User::find($rating->evaluator_id)->pull('lastname')}}</i></h4>
<a href="/app/pds/evaluations/print/{{$rating->id}}" target="_blank" class="btn btn-primary pull-right">Print this page</a>
