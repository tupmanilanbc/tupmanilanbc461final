...
class DocsCtrl extends Auth
{
    ...
    {
        return View::render('admin/docs/index');
    }
    ...
    {
        return View::render('admin/docs/upload');
    }
    ...
    public function fetch()
    {
        ...
        foreach ($files as $media):
            ...
            <tr>
                ...
                <td>$owner->username [$owner->role]</td>
                <td>$date</td>
    ...
    {
        $files = Media::where('user_id', $id)->order('id','desc')->get();
        ...
        foreach ($files as $media):
            ...
            <tr>
                ...
                <td>$date</td>
                <td class='table-manage'>
                    <a class='action btn-download' href='".route('admin.docs.download',$media->id)."'></a>
                </td>
            </tr>");
        endforeach;
